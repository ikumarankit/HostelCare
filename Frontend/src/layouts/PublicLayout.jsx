...
export default function PublicLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50 dark:bg-dark-950">
      ...
      <footer className="bg-slate-100 dark:bg-dark-900 border-t border-slate-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <span className="text-lg font-semibold bg-slate-100 dark:bg-dark-900">HostelCare</span>
              </div>
              <p className="bg-slate-100 dark:bg-dark-900 text-sm max-w-md leading-relaxed">
                Hostel Issue Management System. <br /> Students report issues; wardens resolve them floor by floor.
              </p>
            </div>
            <div>
              <h4 className="text-sm font-semibold bg-slate-100 dark:bg-dark-900 mb-4">Links</h4>
              <ul className="space-y-2">
                <li>
                  <a href="#features" className="text-sm bg-slate-100 dark:bg-dark-900 hover:text-primary-400 transition-colors">
                    Features
                  </a>
                </li>
                <li>
                  <a href="#how-it-works" className="text-sm bg-slate-100 dark:bg-dark-900 hover:text-primary-400 transition-colors">
                    How it works
                  </a>
                </li>
                <li>
                  <Link to="/login" className="text-sm bg-slate-100 dark:bg-dark-900 hover:text-primary-400 transition-colors">
                    Login
                  </Link>
                </li>
              </ul>
          ...
          <div className="mt-10 pt-6 border-t border-slate-800 text-center">
            <p className="text-sm bg-slate-100 dark:bg-dark-900">© {new Date().getFullYear()} HostelCare. All rights reserved ( :</p>
          </div>
        </div>
      </footer>
    </div>
